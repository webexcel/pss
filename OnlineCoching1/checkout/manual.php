...
////////////////////////////////////////////
	...
	$ADNO	  =	  $data['ADNO'];
	// Use the server-computed balance from pay.php (5000 / 1500) when available,
	// so the displayed + submitted amount always matches the Razorpay order.
	$amount	  =   isset($ASamount) ? $ASamount : $data['amount'];
			...
			<tbody>
				...
				<tr>
					<td colspan="3">
						...
						<input type="hidden" name="callback_url" value="https://pssenior.edu.in/OnlineCoching/verify.php">
					</td>
