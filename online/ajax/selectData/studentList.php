...
if( $section == "" ) {
	$query	=	" SELECT `CLASS_ID`, Standard AS STD, Section AS SEC, CONCAT(`Standard`, '-', `Section`) AS CLASS_SECTION, `NAME`, `FATHER_NAME`, `ADMISSION_ID` FROM `v_studentlist` WHERE 1 ";	
} else {
