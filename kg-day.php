            ...
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">KG / Primary School Programmes<span></h1>
						                    </div>
				                    </div>
					<div class="container about_slider_bg   academics_the_curriculum    container-fluid container-fluid break-genesis">
                    																																																																														                         
						     
					<div class=" col-xs-12 col-sm-12 col-md-12">
					
						<div class=" col-xs-12 col-sm-4 col-md-4">
						<a href="kgday.php"><p><b>KG Programmes</b></p></a>						
							<a href="kgday.php"><img src="img/activity/kg day/kg264.jpeg" alt="" width="250px" height="180px" /></a>
						
						</div>
						<div class=" col-xs-12 col-sm-4 col-md-4">
							<a href="primary-day.php"><p><b>Primary School Programmes</b></p>	</a>					
								<a href="primary-day.php"><img src="img/activity/primary day/PrimaryDay-2020-1.png" alt="" width="250px" height="180px" /></a>
