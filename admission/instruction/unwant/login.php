            ...
            <div class="portlet box green">
                <div class="portlet-body form">
                    ...
                    <div class="form-horizontal form-row-sepe">
                        <div class="form-body">
						<form name="frm" action="check_login.php" method="post">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <input class="form-control" data-val-required="Enter Mobile No" id="mobile" name="mobile" type="text" required/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
											<input class="form-control" data-val-required="Enter the DOB" type="date" id="strDOB1" name="strDOB1" value="" required/>
                                            </div>
                                        </div>
								</div>											
