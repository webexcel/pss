        ...
        <div class="row">
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">Mandatory Public Disclosure<span></h1>
						                    </div>
				                    </div>
			<div class="container about_slider_bg   academics_the_curriculum  residential_school_content   container-fluid container-fluid break-genesis">
					...
					<!-- <p><b>Founder:</b> Shri. Pennathur Subramanya Iyer (1830-1901)</p>-->
						<!--<p style="text-align:justify">School information in the CBSE prescribed OASIS (Online Affiliated School Information System) format:<p>-->

						<!--<p><a href="pdf/OASIS_FORM_2023.pdf" target="_blank">CBSE_OASIS_2023	</a></p>-->	
						
							<p style="color:red;"><a href="pdf/Mandatory Disclosure Details _ SARAS 4.0.pdf" target="_blank"><b> ** Mandatory Disclosure Details	</b></a></p>
							
							<p><a href="pdf/ANNUAL_ACADEMIC_CALENDAR_2024-25.pdf" target="_blank"><b>1 . Annual_Academic_Calander</b></a></p>
							<p><a href="pdf/Building_Safety_Certificate.pdf" target="_blank"><b>2 . Building Safety Certificate</b></a></p>							
							<p><a href="pdf/Sanitary Certificate 2024-25 _resized.pdf" target="_blank"><b>3 . WATER HEALTH SANITATION CERTIFICATE</b></a></p>
							<p><a href="pdf/No_Objection_Certificate.pdf" target="_blank"><b>4 . No Objection Certificate</b></a></p>
							<p><a href="pdf/Fire Certificate_resized.pdf" target="_blank"><b>5 . Fire Safety Certificate</b></a></p>
							<!--<p><a href="pdf/Drinking Water Certficate.pdf" target="_blank"><b>6 . Drinking Water Certficate</b></a></p>	-->
							<p><a href="pdf/StateGovernment  Recognition Certificate.pdf" target="_blank"><b>6 . StateGovernment Recognition Certificate</b></a></p>
