var fetch = angular.module('myApp', ["xeditable", "ui.bootstrap"]);
	...
	fetch.controller('dbCtrl', function($window,$location,$scope, $filter, $http, $timeout) {
		...
		$scope.sendAll = function() {
			...
			$http({
				method: "post",
				url: "ajax/sms/personal/sendAllPersonal.php",
				data: { uStud: $scope.ID },
				headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
			}).success(function(response) {
				location.reload();
		...
		$scope.delPersonal = function() {
			...
			$http({
				method: "post",
				url: "ajax/sms/personal/delPersonal.php",
				data: {
		...
		$scope.sendPersonal = function() {
			console.log($scope.dStud);							
			$http({
				method: "post",
				url: "ajax/sms/personal/sendPersonal.php",
				data: {
					uStud: $scope.dStud
					},
				headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
		...
		$scope.editPersonal = function() {
			...
			$http({
				method: "post",
				url: "ajax/sms/personal/editPersonal.php",
				data: {
