    ...
    <div class="container-fluid about_container ">
        <div class="row">
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">Safety and Security<span></h1>
						                    </div>
				                    </div>
			<div class="container about_slider_bg   academics_the_curriculum  residential_school_content   container-fluid container-fluid break-genesis">
					...
					<p style="text-align:justify">The safety and security of the students and staff of our school are of paramount importance to us. Government prescribed COVID norms of sanitation , social distancing, etc have all been followed religiously.  Accordingly, the school has installed pedal sanitizers at the entrance and social distancing is strictly maintained through constant monitoring and ear marking spaces for footfalls. The temperature of everyone entering the school premises is checked before permitting entry. Face masks are insisted upon and are provided to those who require them. The security officers at the gate maintain a visitor's notebook to collect details from all visitors to the school.</p>  
					<p style="text-align:justify">A committee headed by the Principal constantly monitors the safety and security measures of the campus. </p>
						<p><u></u><strong><span style="color: #395c97;"><u>MEMBERS OF THE COMMITTEE FOR SAFETY AND SECURITY</u></span></strong></p>
						<ol>
						<!--<li>Smt. Revathy Parameswaran, Principal</li>
						<li>Smt. N. Padmasri, Vice Principal</li>
						<li>Shri. V. Thirumurugan</li>
						<li>Shri. A. Babu Abraham</li>
						<li>Shri. S Sathish Yadav</li>
						<li>Smt. R Geethalakshmi  (PTA President)</li>
						<li>Shri. Ranganathan Sundaram (PTA Secretary)</li>
						<li>Aashrith Sudarshan Narayn (School Pupil Leader)</li>
						<li>Sahitya Srinath (Assistant School Pupil Leader)</li>-->
