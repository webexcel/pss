...
$arrayfee = array();
	...
	WHERE fee.interval = '4' AND fee.Admission_No  IN (SELECT Admission_No FROM student_class_map WHERE Admission_No =  '".$arr['ADNO']."' AND Year_Id = '".$yearId."' ) AND feestatus.Admission_Id = '".$arr['ADNO']."'  AND feestatus.Year_Id = '".$yearId."' order by feestatus.Fee_Headid ";
