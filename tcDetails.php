        ...
        <div class="row">
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">Student TC’s Issue Details<span></h1>
						                    </div>
				                    </div>
			<div class="container about_slider_bg   academics_the_curriculum  residential_school_content   container-fluid container-fluid break-genesis">
					...
					<div class=" col-xs-12 col-sm-9 col-md-9">
						<p><a href="pdf/TC - 2022-2023.pdf" target="_blank">Click here to view the Student’s TC List  for the academic year 2022-23</a></p>
						<p><a href="pdf/TC_LIST_2020-21.pdf" target="_blank">Click here to view the Student’s TC List  for the academic year 2020-21</a></p>
						<p><a href="pdf/TC_LIST_2019-20-2.pdf" target="_blank">Click here to view the Student’s TC List  for the academic year 2019-20</a></p>
						<p><a href="pdf/TC_LIST_2018-19-1.pdf" target="_blank">Click here to view the Student’s TC List  for the academic year 2018-19</a></p>						
					</div>
