...
class PdfGenerator extends Fpdi
{
    ...
    private array $page1Fields = [
        ...
        'student_name'      => ['x' => 84, 'y' => 101],
        'date_of_birth'     => ['x' => 84, 'y' => 113],
        'gender'            => ['x' => 84, 'y' => 124],
        'address'           => ['x' => 14, 'y' => 151, 'multiline' => true, 'width' => 150],
        'community'         => ['x' => 88, 'y' => 184],
        'emis_number'       => ['x' => 88, 'y' => 202],
        'maths_type'        => ['x' => 88, 'y' => 220],
        'previous_school'   => ['x' => 88, 'y' => 241],
        'integrated_course' => ['x' => 88, 'y' => 260],
    ];
    ...
    private array $page2Fields = [
        ...
        'father_qualification'  => ['x' => 73, 'y' => 60],
        'father_occupation'     => ['x' => 73, 'y' => 72, 'multiline' => true, 'width' => 48, 'lineHeight' => 5],
        'father_mobile'         => ['x' => 73, 'y' => 101],
        'father_email'          => ['x' => 73, 'y' => 113],
        'father_income'         => ['x' => 73, 'y' => 126],

        // Mother column (2mm from left edge of cell)
        'mother_name'           => ['x' => 134, 'y' => 47],
        'mother_qualification'  => ['x' => 134, 'y' => 60],
        'mother_occupation'     => ['x' => 134, 'y' => 72, 'multiline' => true, 'width' => 48, 'lineHeight' => 5],
        'mother_mobile'         => ['x' => 134, 'y' => 101],
        'mother_email'          => ['x' => 134, 'y' => 113],
        'mother_income'         => ['x' => 134, 'y' => 126],
    ...
    private function fillPage1(array $data): void
    {
        ...
        $this->writeField('web_no', $application['application_id'] ?? '', $this->page1Fields, 11);
     ...
     */
    private function writeField(string $fieldName, string $value, array $fields, int $fontSize = 12): void
    {
    ...
    private function writeMultilineField(string $fieldName, string $value, array $fields): void
    {
        ...
        $lineHeight = $field['lineHeight'] ?? 3;

        $this->SetFont('Helvetica', '', 10);
        $this->SetXY($field['x'], $field['y']);
        $this->MultiCell($width, $lineHeight, $this->cleanText($value), 0, 'L');
    }
