    ...
    <div class="container-fluid about_container ">
        <div class="row">
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">Student Safeguarding Advisory Committee <span></h1>
						                    </div>
				                    </div>
			<div class="container about_slider_bg   academics_the_curriculum  residential_school_content   container-fluid container-fluid break-genesis">
					...
					<p style="text-align:justify"><b>To ensure the safety of students, girls in particular, a committee has been set up to look into complaints of sexual misconduct 
					and to take stringent action against those indulging in such offences. </b></p>
					<p style="text-align:justify">Please read the School’s Policy document on Sexual Harassment to know more about the functioning of the committee.</p>
					<p><span style="color: #0000ff;"><a style="color: #0000ff;" href="pdf/School-Policy-on-Sexual-Harassment.pdf">School&#8217;s Policy document on Sexual Harassment-Click here</a></span></p>	
						...
						<!--<p style="text-align: left;"><u><br />
						<strong><span style="color: #395c97;">MEMBERS OF THE SEXUAL HARASSMENT PREVENTION COMMITTEE</span></strong></u></p>
						<ol>
						<li>Smt. Revathy Parameswaran, Principal</li>
						<li>Smt. N. Padmasri,Vice Principal</li>
						<li>Smt. Patricia Lucy, HOD, Biology</li>
						<li>Smt. N. Logeswari, Student Counsellor</li>
						<li> Shri. P Muthuselvam</li>
						</ol>-->
