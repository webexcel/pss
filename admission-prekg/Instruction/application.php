	...
	<div class="row test1">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<h2 class="regheading" style="text-align: center;">P.S.Senior Secondary School</h2>
						...
						<strong>ONLINE APPLICATION FORM FOR ADMISSION TO KG (2026-2027)</strong></h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group strDOBPREKG">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                DATE OF BIRTH<span class="required">* </span>
                                            </label>
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">		
												<input type="date" class="form-control" type="text" id="strDOB1" name="strDOB1" min="2022-12-01" max="2023-11-30" tabindex="6" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >									
													
											</div>
                                        </div>
										
										<div class="form-group strDOBLKG">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                DATE OF BIRTH<span class="required">* </span>
                                            </label>
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
												<input type="date" class="form-control" type="text" id="strDOB2" name="strDOB2" min="2021-12-01" max="2022-11-30" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >													
											</div>
                                        </div>
										
										<div class="form-group strDOBUKG">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                DATE OF BIRTH<span class="required">* </span>
                                            </label>
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">		
												<input type="date" class="form-control" type="text" id="strDOB3" name="strDOB3" min="2020-12-01" max="2021-11-30" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >	
											</div>
                                        </div>                                                                         
                                       <!-- <div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">		
												<input type="date" class="form-control" type="text" id="strDOB" name="strDOB" tabindex="6" min="2018-12-01" max="2019-11-30" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >									
											</div>
                                        </div>-->
										<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                       ...
                                       <!-- <div class="form-group">
                                            ...
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12  text-right">
                                               FATHER'S MOBILE  NO.<span class="required">* </span>
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input class="form-control" data-val="true" data-val-required="Please enter Father MobileNo" id="MobileNo" name="MobileNo" onkeyup="ChangeCase(this);" tabindex="14" type="text" value="" />
                                                    </div>
                                                </div>
                                        </div>
                                            ...
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12  text-right">
                                               MOTHER'S MOBILE NO.<span class="required">* </span>
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input class="form-control" data-val="true" data-val-required="Please enter Mother MobileNo" id="MobileNo1" name="MobileNo1" onkeyup="ChangeCase(this);" tabindex="15" type="text" value="" />
                                                    </div>
                                                </div>
                                        </div>
										...
										<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <textarea class="form-control" id="AddressP" maxlength="500" name="AddressP" onkeypress="return AddressValidate(event)" onkeyup="ChangeCase(this);" tabindex="17"></textarea>
                                                    </div>
                                                </div>
                                        </div>
										<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12  text-right">
                                               PINCODE<span class="required">* </span>
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input class="form-control" data-val="true" id="Pincode" name="Pincode" tabindex="18" type="text" value="" />
                                                    </div>
                                                </div>
                                        </div>
                                            ...
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12  text-right">
                                               HEALTH PROBLEMS(IF ANY)
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i>
                                                        <input class="form-control" data-val="true" id="health" name="health" tabindex="19" type="text" value="" />
                                                    </div>
                                                </div>
                                        </div>
										...
										<!--<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                BIRTH CERTIFICATE <span class="required">* </span>
                                            </label>
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i><input class="form-control" type="file" name="file1" id="file1" data-val="true" data-val-required="Please enter Birth Certificate" tabindex="20">                                                       
                                                    </div>
                                                </div>
                                        </div>
										<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                ANY GOVT APPROVED ADDRESS PROOF(AADHAR OF THE PARENT)<span class="required">* </span>
                                            </label>
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i><input class="form-control" type="file" name="file2" id="file2" data-val="true" data-val-required="Please enter Birth Certificate" tabindex="21">                                                       
                                                    </div>
                                                </div>
                                        </div>
										<!--<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                REPORT CARD OF PREVIOUS YEAR CLASS<span class="required">* </span>
                                            </label>
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
												...
												<!--<tr>
                                                    <td>QUALIFICATION CERTIFICATE
                                                    </td>
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="file" name="file3" id="file3" tabindex="21"> 
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="file" name="file4" id="file4" tabindex="21"> 
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
												...
												<tr>
                                                    <td>OFFICE ADDRESS (Employer Name / Address)</td>
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input class="form-control" data-val="true" data-val-required="Please enter FatherOccDetail" id="FatherOccDetail" maxlength="48" name="FatherOccDetail" onkeyup="ChangeCase(this);" style="width:95%" tabindex="30" type="text" value="" />
                                                    ...
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input class="form-control" data-val="true" data-val-required="Please enter MotherOccDetail" id="MotherOccDetail" maxlength="48" name="MotherOccDetail"  onkeyup="ChangeCase(this);" style="width:95%" tabindex="31" type="text" value="" />
                                                    ...
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input class="form-control" id="GuardianOccDetails" maxlength="48" name="GuardianOccDetails" onkeypress="return NameValidate(event)" onkeyup="ChangeCase(this);" tabindex="32" type="text" value="" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <!--<tr>
                                                    <td>PROOF OF EMPLOYMENT 
                                                    </td>
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
														...
														ARE YOU A MEMBER OF P.S.SR.ALUMNI ASSOCIATION<span class="required">* </span>
                                                    </label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        ...
                                                        <span class="radio-list">
                                                            <label class="radio-inline">
                                                                <div class="input-icon right">
                                                                    <i class="fa"></i>
                                                                    <input class="form-radioErrorcontrol" data-val="true" data-val-required="Please select alumni association" id="SiblingStudied2" name="SiblingStudied2" tabindex="39" type="radio" value="Yes" /> YES 
                                                                </div>
                                                            </label>
                                                            <label class="radio-inline">
                                                                <div class="input-icon right">
                                                                    <i class="fa"></i>
                                                                    <input Checked="checked" class="form-radioErrorcontrol" id="SiblingStudied2" name="SiblingStudied2" tabindex="40" type="radio" value="No" /> NO
                                                                </div>
                                                            </label>
                                                        </span>
...
<script>
    ...
    // Hide - Show Event
		...
		$( document ).ready(function() {
			...
			$(".strDOBLKG").hide();
			$(".strDOBUKG").hide();
			$('#AppliedForKGS').change(function () {
				var applied = $('#AppliedForKGS').val();
				if(applied == 'PREKG'){
					$(".strDOBPREKG").show();
					$(".strDOBLKG").hide();
					$(".strDOBUKG").hide();				
...
<script type="text/javascript">
    ...
    function fnSubmit() {
        ...
        try {
			...
			if(datee < "2018-12-01" || datee > "2021-11-30"){
                required: true,
				$(".strDOB").focus();			
            }
            fnFormValidation();
    ...
    function fnSiblingsValidation() {
        ...
        try {
			...
			var MobileNo1 = $("#MobileNo1").val().replace('_', '');
