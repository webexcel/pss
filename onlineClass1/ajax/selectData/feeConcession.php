...
$query	=	" SELECT `FEE_CON_ID`, `ADMISSION_ID`, `CONCESSION_AMOUNT`, `CONCESSION_APPROVED_BY`, `CONCESSION_REMARKS`, `CONCESSION_APPROVED_DATE`, `CONCESSION_STATUS` FROM `fee_concession` WHERE `ADMISSION_ID` = '".$adno."' ";
//echo "SQL : " . $query . "<br />";
