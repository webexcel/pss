	...
	fetch.controller('dbCtrl', function($window,$location,$scope, $filter, $http, $timeout) {
		...
		$scope.saveStudent = function(saveValues) {
			...
			if ($scope.myForm.$valid) {			
				$http({
					method: "post",
					url: "ajax/sms/latecomers/inslatecomers.php",
		...
		$scope.getlatecomerslist = function() {
			var request = $http({
				method: "post",
				url: "ajax/sms/latecomers/getlatecomerslist.php",
		...
		$scope.sendAll = function() {
			...
			$http({
				method: "post",
				url: "ajax/sms/latecomers/sendAllLatecomers.php",
				data: { uStud: $scope.ID },
				headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
			}).success(function(response) {
		...
		$scope.deletelate = function() {
			...
			$http({
				method: "post",
				url: "ajax/sms/latecomers/delLatecomers.php",
				data: {
		...
		$scope.sendlatecomers = function() {
			...
			$http({
				method: "post",
				url: "ajax/sms/latecomers/sendLatecomers.php",
				data: {
					uStud: $scope.dStud
					},
				headers: { 'Content-Type': 'application/x-www-form-urlencoded' }
