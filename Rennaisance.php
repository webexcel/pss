            ...
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">Renaissance<span></h1>
						                    </div>
				                    </div>
					...
					<div class=" col-xs-12 col-sm-12 col-md-12">
						<p style="text-align:justify;">Renaissance 2021, Intra school competitions were organized by the School TFE Team. Students from classes 9 to 12 participated in various competitions conducted both Online and Offline.</p>
						<p style="text-align:justify;">The competitions conducted offline are: Western Instruments, Art, Dance, TED Talk, Creative Writing, Photography.</p>
						<p style="text-align:justify;">The competitions conducted online are:Mono Acting, JAM, Shark Tank, Carnatic (Vocal), Carnatic (Instrumental), Block & Tackle, Lawyer’s Up.</p>
						<div class="col-md-6">
							<img src="img/activity/Rennaisance/img1.png" alt="" class="img-response"/>
						</div>
						<div class="col-md-6">
							<img src="img/activity/Rennaisance/img2.png" alt="" class="img-response"/>
						</div>
					</div>
					<div class=" col-xs-12 col-sm-12 col-md-12">
						<div class="col-md-4">
							<img src="img/activity/Rennaisance/img3.png" alt="" class="img-response"/>
						</div>
						<div class="col-md-4">
							<img src="img/activity/Rennaisance/img4.png" alt="" class="img-response"/>
						</div>
						<div class="col-md-4">
							<img src="img/activity/Rennaisance/img5.png" alt="" class="img-response"/>
						</div>
					</div>
					<div class=" col-xs-12 col-sm-12 col-md-12">
						<div class="col-md-4">
							<img src="img/activity/Rennaisance/img6.png" alt="" class="img-response"/>
						</div>
						<div class="col-md-4">
							<img src="img/activity/Rennaisance/img7.png" alt="" class="img-response"/>
						</div>
