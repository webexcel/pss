        ...
        <div class="row">
            <div class="container-fluid">
                  <div class="container multipurpose_hall container  multipurpose_hall admission_container">
					...
					<!--<h2 class="h3_trigger ggs_about_team" id="6">why-genesis</h2>-->
                        <h1><span class="h3_trigger ggs_about_team" id="6">Latest at PSS<span></h1>
						                    </div>
				                    </div>
			<div class="container about_slider_bg   academics_the_curriculum  residential_school_content   container-fluid container-fluid break-genesis">
					...
					<div class=" col-xs-12 col-sm-9 col-md-9">
						...
						<p id="1"><b>Integrated Classroom programme for Class 9</p>
						
						<p>We are pleased to inform you about the launch of the Integrated Classroom programme for Class 9 in our school.</p>
						
						<p>This  initiative blends preparatory coaching for JEE / NEET with the CBSE curriculum,  creating a cohesive learning experience that strengthens the understanding of core concepts in Maths and Science.</p>

						<p>The programme is designed to develop problem-solving skills, critical thinking, and time management in students, thus  preparing them not only for IIT-JEE but also for future success in college and beyond. </p>

						<p>Senior faculty and Head of the departments of Maths and Science with rich experience in pedagogy will be handling the foundation classes.</p>

						<p><a href="pdf/Foundation Classes for JEE-NEET.pdf">Click here to learn more about the programme.</a></p>

						<p><a href="https://pssenior.edu.in/onlineIX">Click here to pay the fees and enroll.</a></p>
...
<script>
	var $somevar = $_GET["1"];
	var link = document.getElementById('somevar');
	alert(link);
