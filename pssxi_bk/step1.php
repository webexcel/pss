        ...
        <form id="step1-form" class="bg-surface-light dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div class="p-6 md:p-8 space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <!-- Community -->
                    <label class="flex flex-col gap-2 group">
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300 group-focus-within:text-primary transition-colors">Community</span>
                        <div class="relative">
                    ...
                    <!-- EMIS Number -->
                    <label class="flex flex-col gap-2 group">
                        <span class="text-sm font-medium text-slate-700 dark:text-slate-300 group-focus-within:text-primary transition-colors">EMIS Number</span>
                        <div class="relative">
                            ...
                            <input type="text" name="emis_number" id="emis_number"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <label class="flex flex-col gap-2 group md:col-span-2">
                            <span class="text-sm font-medium text-slate-700 dark:text-slate-300 group-focus-within:text-primary transition-colors">Previous School</span>
                            <div class="relative">
                        ...
                        <!-- Maths Type -->
                        <label class="flex flex-col gap-2 group">
                            <span class="text-sm font-medium text-slate-700 dark:text-slate-300 group-focus-within:text-primary transition-colors">Maths Type (Class 10)</span>
                            <div class="relative">
                                ...
                                <select name="maths_type" id="maths_type"
                                        class="form-select w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50 pl-10 h-12 focus:border-primary focus:ring-primary/20 dark:text-white transition-all">
                        ...
                        <div class="col-span-1 md:col-span-2 lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:col-span-4 gap-4 bg-slate-50 dark:bg-slate-800/30 p-4 rounded-lg border border-slate-100 dark:border-slate-800">
                            <p class="col-span-full text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1">Subject Group Preferences (For Class 11-12)</p>

                            <?php for ($i = 1; $i <= 4; $i++): ?>
                            <label class="flex flex-col gap-2">
                                <span class="text-xs font-medium text-slate-600 dark:text-slate-400">Preference <?= $i ?></span>
                                <select name="subject_pref_<?= $i ?>" id="subject_pref_<?= $i ?>"
                        ...
                        <div class="col-span-1 md:col-span-2 lg:col-span-3">
                            <label class="flex flex-col gap-2 group">
                                <span class="text-sm font-medium text-slate-700 dark:text-slate-300">Do you want to apply for Integrated Course?</span>
                                <div class="flex items-center gap-6">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="integrated_course" value="Yes"
                                    ...
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="integrated_course" value="No"
