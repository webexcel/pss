...
$query	=	" SELECT  `class` AS CLASS_SECTION, `name`, `adno`  FROM `v_coachlist_glps` WHERE `adno` = '".$adno."' and `Year_Id` = '".$yearId."'";
...
$sqlFeeHistory	=	"SELECT `sel_coaching`,`pay_id`,date(`insDate`) as `insDate` FROM `v_coachlist_glps` WHERE `adno` = '".$adno."'";
