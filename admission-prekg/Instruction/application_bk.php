	...
	<div class="row test1">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<h2 class="regheading" style="text-align: center;">P.S.Senior Secondary School</h2>
						...
						<strong>ONLINE APPLICATION FORM FOR ADMISSION TO CLASSES PREKG (2023-2024)</strong></h4>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group strDOBPREKG">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">		
												<input type="date" class="form-control" type="text" id="strDOB" name="strDOB" min="2019-12-01" max="2020-05-31" tabindex="6" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >									
										...
										<div class="form-group strDOBLKG">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
												<input type="date" class="form-control" type="text" id="strDOB" name="strDOB" min="2018-12-01" max="2019-05-31" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >													
											</div>
                                        </div>
										...
										<div class="form-group strDOBUKG">
                                            ...
                                            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">		
												<input type="date" class="form-control" type="text" id="strDOB" name="strDOB" min="2017-12-01" max="2018-05-31" date-format="dd-mm-yyyy" data-val-required="Invalid Date of birth" >	
											</div>
                                        </div>
                                       ...
                                       <!-- <div class="form-group">
										...
										<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i><input type="file" name="file1" id="file1" tabindex="20">                                                       
                                                    </div>
                                                </div>
                                        </div>
										<div class="form-group">
                                            <label class="col-lg-5 col-md-5 col-sm-5 col-xs-12 text-right">
                                                ...
                                                <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
                                                    <div class="input-icon right">
                                                        <i class="fa"></i><input type="file" name="file2" id="file2" tabindex="21">                                                       
                                                    </div>
                                                </div>
                                        </div>
										<!--<div class="form-group">
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input class="form-control" data-val="true" data-val-required="Please enter FatherOccDetail" id="FatherOccDetail" maxlength="48" name="FatherOccDetail" onkeypress="return NameValidate(event)" onkeyup="ChangeCase(this);" style="width:95%" tabindex="30" type="text" value="" />
                                                    ...
                                                    <td>
                                                        <div class="form-group tblItem">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input class="form-control" data-val="true" data-val-required="Please enter MotherOccDetail" id="MotherOccDetail" maxlength="48" name="MotherOccDetail" onkeypress="return NameValidate(event)" onkeyup="ChangeCase(this);" style="width:95%" tabindex="31" type="text" value="" />
                                                                        ...
                                                                        <tbody>
                                                                                <tr id="AName" style="display:none;">
																					...
																					<td>
                                                                                        <div class="input-icon right">
                                                                                            <i class="fa"></i>
                                                                                            <input class="form-control" id="YClass" name="YClass" onkeypress="return NameValidate(event)"  type="text" value="" tabindex="51"/>
                                                                                        </div>
                                                                                    </td>
                                                                                    <td>
                                                                                        <div class="input-icon right">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="input-icon right">
                                                                                            <i class="fa"></i>
                                                                                            <input class="form-control" id="CClass" name="CClass" onkeypress="return NameValidate(event)" onkeyup="ChangeCase(this);" type="text" value="" tabindex="53"/>
                                                                                        </div>
                                                                                    </td>
