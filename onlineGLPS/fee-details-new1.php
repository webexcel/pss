			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>INTEGRATED COURSE FEES COLLECTION</h1>
					</div>
					<!-- /.page-header -->
					<div class="row">
						<div class="col-md-12">
						...
						<div class="row">
							...
							<div class="col-md-6" style="padding-top:17px;">
									...
									<td colspan="2">Fees Amount</td>								
										<td>
											<span style="color:red">RS . 3000</span><!--Change Here amount -->
										</td>
									</tr>
							...
							<!--<div class="col-md-6" style="padding-top:17px;" ng-repeat="(key1, val1) in user2">	-->							
								<div class="table-header table-header profile-user-info width mb-5"><b>FEES PAID HISTORY</b></div>                
									...
									<tr>
										...
										<td><a href='bills/pssenior.php?r={{user1.pay_id}}&adno={{user.ADNO}}&name={{user.NAME}}&game={{user1.game}}&date={{user1.date}}&classsec={{user.SECTION}}&yearid=6' target='_blank' class="btn btn-minier btn-success no-border"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print</a></td>
									</tr>
									<tr>
	...
	fetch.controller('dbCtrl', function($window,$location,$scope,$filter, $http, $timeout, $modal) {
		...
		$scope.payFees	=	function(user) {						
			...
			if ($scope.myForm.$valid) {	
				...
				stuFeeDetails1.push({  "ADNO":fadno,"name":name,"classsec":classsec});
