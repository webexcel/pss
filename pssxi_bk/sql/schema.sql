...
CREATE TABLE `applications` (
    ...
    `application_id` VARCHAR(20) NOT NULL UNIQUE COMMENT 'Public ID e.g., ADM-2024-00001',
...
CREATE TABLE `students` (
    ...
    `subject_pref_1` VARCHAR(50) DEFAULT NULL COMMENT 'Subject group preference 1',
    `subject_pref_2` VARCHAR(50) DEFAULT NULL COMMENT 'Subject group preference 2',
    `subject_pref_3` VARCHAR(50) DEFAULT NULL COMMENT 'Subject group preference 3',
    `subject_pref_4` VARCHAR(50) DEFAULT NULL COMMENT 'Subject group preference 4',
