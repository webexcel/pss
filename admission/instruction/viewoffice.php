							...
							<div class="row">   						
								<table  class="datatable table table-hover table-bordered">
									...
									<tbody style="border-top:#585454;">	
										...
										//$result = mysqli_query($dbconnect,"select t1.id,t1.fno,t1.name,t1.dob,t1.fname,t1.addressP,t1.contact,t1.applied,t1.photo,t1.fphoto,t2.adno from application_prekg t1 join student_db t2 on t1.adno1 = t2.adno where t1.status = '0'");
										while($row = mysqli_fetch_assoc($result))
										  {
											$id           = $row['id'];
											$fno          = $row['fno'];
											...
											/*
											$result1 = mysqli_query($dbconnect,"select adno as adno1 from student_db where adno = '".$adno."'");
