...
$exeFee	=	mysqli_query($con, $sql_feehead);
$arrayfee = array();
	...
	WHERE fee.interval IN (1) AND fee.Admission_No  IN (SELECT Admission_No FROM student_class_map WHERE Admission_No =  '".$arr['ADNO']."' AND Year_Id = '".$yearId."' ) AND feestatus.Admission_Id = '".$arr['ADNO']."'  AND feestatus.Year_Id = '".$yearId."' order by feestatus.Fee_Headid ";
$exeFeeDetails	=	mysqli_query($con, $sqlFeeDetails);
...
if( $cntFeeDetails > 0 ) {
	...
	/////////////////////// Concession starts Here/////////////////////////////////////////////////	
		...
		$exeCon	=	mysqli_query($con,$sqlCon);
