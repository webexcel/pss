		...
		*/
		...
		$scope.saveStudent = function(aStudent) {
			...
			if ($scope.myForm.$valid) {
				...
				$http({
					method: "post",
					url: "ajax/insertData/insStudent1.php",
					data: {
		...
		$scope.getCSVHeader	= function () {return ["ADMISSION_NO", "CLASS_ID", "NAME", "FATHER_NAME", "GENDER", "DOB"]};
		var CSVBody	= new Array();
		$scope.CSVBody = {"ADMISSION_NO":'XXXX' , "CLASS_ID":'XXXX', "NAME":'XXXX', "FATHER_NAME":'XXXX', "GENDER": 'XXXX', "DOB": 'XXXX'};
